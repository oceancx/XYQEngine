...
namespace star
{
	...
	/// </summary>
	class SpriteArrayComponent : public BaseComponent
	{
	public:
		/// <summary>
		/// Initializes a new instance of the <see cref="SpriteArrayComponent"/> class.
		/// </summary>
		/// <param name="filepath">
		...
		/// <summary>
		/// Finalizes an instance of the <see cref="SpriteArrayComponent"/> class.
		/// </summary>
		virtual ~SpriteArrayComponent();
	...
	private:
		...
		SpriteArrayComponent(const SpriteArrayComponent &);
		SpriteArrayComponent(SpriteArrayComponent &&);
		SpriteArrayComponent& operator=(const SpriteArrayComponent &);
		SpriteArrayComponent& operator=(SpriteArrayComponent &&);
	};
}
